...
const projects = [
  {
    ...
    image: "/placeholder.svg?height=600&width=600&text=YES-O+Branding",
    description: "visual identity for the young entrepreneurs society organization",
  },
  {
    id: 2,
    title: "Event Materials",
    image: "/placeholder.svg?height=600&width=600&text=YES-O+Events",
    description: "designs for organization events and activities",
  },
  {
    id: 3,
    title: "Social Media Graphics",
    image: "/placeholder.svg?height=600&width=600&text=YES-O+Social",
    description: "content for the organization's online platforms",
  },
  {
    id: 4,
    title: "Print Collaterals",
    image: "/placeholder.svg?height=600&width=600&text=YES-O+Print",
    description: "physical marketing materials and merchandise",
  },
]

export default function YesoPage() {
  return (
    <div className="flex flex-col lg:flex-row min-h-screen">
      <div className="w-full lg:w-1/3 p-8 lg:p-12 lg:sticky lg:top-0 lg:h-screen lg:overflow-auto">
        <div className="max-w-md">
          ...
          <div className="mb-8">
            <h2 className="text-xl font-normal mb-4">YES-O TNHS</h2>
            <p className="lowercase mb-4">
              a comprehensive branding project for the young entrepreneurs society organization at tarlac national high
              school. the work included creating visual identity materials, social media graphics, and event collaterals
              that helped establish the organization's presence from 2020 to 2023.
            </p>
            <p className="text-sm text-neutral-500">2020-2023</p>
          </div>
