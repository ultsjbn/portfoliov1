...
const projects = [
  {
    ...
    image: "/placeholder.svg?height=600&width=600&text=COMSCI+Logo",
    description: "branding for the computer science department",
  },
  {
    id: 2,
    title: "Event Posters",
    image: "/placeholder.svg?height=600&width=600&text=COMSCI+Events",
    description: "promotional materials for department events and activities",
  },
  {
    id: 3,
    title: "Social Media Graphics",
    image: "/placeholder.svg?height=600&width=600&text=COMSCI+Social",
    description: "digital content for the department's online presence",
  },
  {
    id: 4,
    title: "Merchandise Design",
    image: "/placeholder.svg?height=600&width=600&text=COMSCI+Merch",
    description: "designs for department shirts, stickers, and other items",
  },
]

export default function ComSciPage() {
  return (
    <div className="flex flex-col lg:flex-row min-h-screen">
      <div className="w-full lg:w-1/3 p-8 lg:p-12 lg:sticky lg:top-0 lg:h-screen lg:overflow-auto">
        <div className="max-w-md">
          ...
          <div className="mb-8">
            <h2 className="text-xl font-normal mb-4">COMSCI@UP.BAG</h2>
            <p className="lowercase mb-4">
              ongoing design work for the computer science department at the university of the philippines baguio. this
              project involves creating cohesive visual materials for department events, announcements, and academic
              initiatives that represent the technical and innovative nature of the program.
            </p>
